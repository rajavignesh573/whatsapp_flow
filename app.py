...
def save_user():
    ...
    try:
        ...
        return jsonify({
            ...
            'hint': 'Make sure Supabase tables exist. Run supabase_setup.sql in Supabase SQL Editor.'
        }), 500
...
def debug_info():
    ...
    return jsonify({
        ...
        'hint': 'If init_error shows table error, run supabase_setup.sql in Supabase SQL Editor'
    }), 200
